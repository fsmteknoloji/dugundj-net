...
export default function DJlerSayfasi() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F7F6F3' }}>
      ...
      {/* HERO */}
      <div style={{
        background: '#0C0C0C', paddingTop: '120px', paddingBottom: '60px',
        paddingLeft: '64px', paddingRight: '64px', marginTop: '66px',
      }}>
  ...
  return (
    <div
      style={{
        ...
        border: '1px solid #E2E0DB', boxShadow: '0 2px 8px rgba(0,0,0,0.05)',
    ...
    >
      <div style={{ height: '240px', position: 'relative', overflow: 'hidden', background: 'linear-gradient(135deg, #1a1a2e, #2d1b5e)' }}>
        ...
        {dj.profil_foto ? (
          ...
          <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ fontFamily: 'var(--font-cormorant)', fontSize: '64px', fontWeight: 300, color: 'rgba(255,255,255,.2)' }}>
              {dj.isim.charAt(0)}
            </div>
          </div>
        )}
      ...
      <div style={{ padding: '18px 20px 22px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', paddingTop: '12px', borderTop: '1px solid #F0EEF8' }}>
          <span style={{ fontSize: '12px', color: '#6B1FFF' }}>{'★'.repeat(Math.round(dj.puan))}</span>
