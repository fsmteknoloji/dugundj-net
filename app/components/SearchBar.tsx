  ...
  return (
    <div style={{ background: '#fff', borderBottom: '1px solid #E2E0DB' }}>
      <div style={{
        ...
        <div style={{ flex: 1, borderRight: '1px solid #E2E0DB', padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: '7px' }}>
        ...
        <button style={{
          background: '#6B1FFF', color: '#fff', border: 'none', padding: '0 44px',
